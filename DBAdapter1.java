...
public class DBAdapter1 {
	...
	// ---------------for user details------------
	public static final String KEY_ROWID = "_id";// to save id //$NON-NLS-1$
	public static final String KEY_USERNAME ="username"; //$NON-NLS-1$
	public static final String KEY_PASSWORD = "password"; //$NON-NLS-1$
	public static final String KEY_USERTYPE ="usertype"; //$NON-NLS-1$
	public static final String KEY_FIRSTNAME = "firstname";
	public static final String KEY_LASTNAME = "lastname"; //$NON-NLS-1$
	public static final String KEY_FATHERNAME ="fathername";
	public static final String KEY_MOBILE ="mobile"; //$NON-NLS-1$
	public static final String KEY_EMAILID ="emailid"; //$NON-NLS-1$
	public static final String KEY_ADDRESS = "address"; //$NON-NLS-1$
	public static final String KEY_DATE ="date1";// to save date of registration table //$NON-NLS-1$
	public static final String KEY_TIME ="time1";// to save time //$NON-NLS-1$
	public static final String KEY_STATUS ="status";// to check status of task //$NON-NLS-1$

	private static final String TAG = "db";// for database adapter //$NON-NLS-1$

	public static final String DATABASE_NAME = "tipister"; //$NON-NLS-1$
	...
	private static final String DATABASE_CREATE = "create table REGISTERATION (_id integer primary key autoincrement, " //$NON-NLS-1$
			+ "username text unique not null,usertype text not null, "
			+ "password text not null,fathername text  null,"
			+ "firstname text not null,lastname text not null,"
			+ "mobile text not null,emailid text unique not null,"
			+ "address text  null, date1 text not null,"
			+ " time1 text not null, status text not null);"; //$NON-NLS-1$
	
	public static final String DATABASE_TABLE_TWEETS = "tbltweets";
	public static final String KEY_Tweets = "tweets"; 

	private static final String DATABASE_CREATE_TWEETS = "create table tbltweets (_id integer primary key autoincrement, " //$NON-NLS-1$
			+ "tweets text unique not null);"; //$NON-NLS-1$
	//
	...
	private static class DatabaseHelper extends SQLiteOpenHelper {
		...
		public void onCreate(SQLiteDatabase db) {
			try {
				...
				db.execSQL(DATABASE_CREATE_TWEETS);
				saveInitialValues(db);
				// db.close();
				Log.i(TAG, "database created"); //$NON-NLS-1$
	...
	public long saveTweets(String tweets) {
		ContentValues initialValues = new ContentValues();
		initialValues.put(KEY_Tweets, tweets);
		

		return db.insert(DATABASE_TABLE_TWEETS, null, initialValues);
...
public Cursor getTweets(String key){
	String sql="select * from "+DATABASE_TABLE_TWEETS+" where tweets like'%"+key+"%'";
	Log.i("SG",sql);
